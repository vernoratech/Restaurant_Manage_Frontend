...
const PageNotFound = () => {
    ...
    return (
        <div>
            ...
            <main class="grid h-screen place-items-center bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
                <div class="text-center">
                    ...
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <a onClick={onSubmit} class=" cursor-pointer rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Go back home</a>
